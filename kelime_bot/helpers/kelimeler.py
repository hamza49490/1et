...
kelimeler = ["güzel ","bilgi ","sorun","sağlamak ","bırakmak","zaman","su","yapmak","kullanılmak","değil","görmek",
             ...
             'ziraat', 'Tarım', 'Çiftçi', 'Toprak', 'Hayvan', 'Banka', 'fabl', 'Hayvan', 'La Fontaine', 'Masal', 'İnsan', 'Hikaye', 'mecaz',
             'Kelime', 'Sözcük', 'Gerçek Anlam', 'Yan Anlam', 'Terim Anlam', 'özne', 'Cümle', 'Kişi', 'Varlık', 'Öge', 'fay', 'Hat', 'Deprem',
             'Kırılmak', 'Sarsılmak', 'İstanbul', 'varsayım', 'Olmamış', 'Tutku', 'Farz et', 'Diyelim', 'Cümle', 'paragraf', 'Sınav', 'Soru',
             'Ana', 'düşünce', 'Yardımcı düşünce', 'Metin', 'üç nokta', 'Noktalama', 'Son', 'Tamamlanmamış', 'İstenmeyen', 'Cümle'
             ...
             'mesai', 'Saat', 'İş', 'Fazla', 'Akşam', 'Kalmak', 'akrostiş', 'Şiir', 'Mısra', 'İsim', 'İlk', 'Kıta', 'bambu', 'Sazlık',
             'Mobilya', 'Ağaç', 'Masa', 'Sandalye', 'yabani', 'Vahşi', 'İlkel', 'Hayat', 'Orman', 'Hayvan', 'yelpaze', 'Sıcak', 'Rüzgar',
             'Yaz', 'Kadın', 'Sallamak', 'çuval', 'Torba', 'Doldurmak', 'Yem', 'Un', 'Koymak', 'ajanda', 'Defter', 'İş', 'Yazmak', 'Gün',
