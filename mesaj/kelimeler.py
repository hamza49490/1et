...
kelimeler = ["güzel", "bilgi", "sorun", "sağlamak", "bırakmak", "zaman","su", "yapmak", "kullanılmak", "değil", "görmek",
             ...
             "eğer", "oysa", "karşılık","vermek", "sahip", "artık", "kişi", "diğer", "dönem", "yine", "bunlar",
             ...
             'servet', 'kazanmak', 'zenginlik', 'mal', 'mülk', 'para', 'tabure', 'oturmak', 'sandalye', 'koltuk', 'yemekhane',
             ...
             'ziraat', 'tarım', 'çiftçi', 'toprak', 'hayvan', 'banka', 'fabl', 'hayvan', 'fontaine', 'masal', 'hikaye', 'mecaz',
             'kelime', 'sözcük', 'gerçekanlam', 'yananlam', 'terimanlam', 'özne', 'cümle', 'kişi', 'varlık', 'öğe', 'fay', 'hat', 'deprem',
             ...
             'yıl', 'çıkmak', 'görmek', 'gün', 'biz', 'gitmek', 'şey', 'ara', 'ki', 'bilmek', 'el', 'zaman',
             'ya', 'çocuk', 'bakmak', 'çalışmak', 'büyük', 'yok', 'başlamak', 'yol', 'kalmak', 'neden', 'siz',
             'konu', 'yapılmak', 'kadın', 'ev', 'diye', 'bulunmak', 'söylemek', 'göz', 'gerekmek', 'dünya',
             'baş', 'durum', 'yan', 'geçmek', 'sen', 'onlar', 'yeni', 'önce', 'başka', 'hâl', 'orta', 'su', 'girmek', 'ülke',
             'yemek', 'hiç', 'bile', 'nasıl', 'bütün', 'karşı', 'bulmak', 'böyle', 'yaşamak', 'düşünmek', 'aynı', 'ancak',
             'kişi', 'bunlar', 'veya', 'göre', 'ön', 'son', 'biri', 'şekil', 'önemli', 'yüz', 'hem', 'göstermek', 'etmek',
             ...
             'arkadaş', 'ürün', 'aile', 'üç', 'okumak', 'erkek', 'herkes', 'güç', 'belki', 'gerçek', 'tam',
             ...
             'dil', 'şirket', 'kaynak', 'bitmek', 'program', 'devametmek', 'hareket', 'renk', 'açılmak', 'hak',
             ...
             'yaratmak', 'ulaşmak', 'sanmak', 'geçirmek', 'kültür', 'kurmak', 'fakat', 'buna', 'resim', 'ışık',
             'hanım', 'hizmet', 'ihtiyaç', 'nokta', 'yön', 'evet', 'oyun', 'artmak', 'yeniden', 'kısa', 'kolay',
             ...
             'araba', 'ağız', 'duygu', 'uygulamak', 'hâlâ', 'örnek', 'birçok', 'derece', 'mümkün', 'şöyle',
             ...
             'sürekli', 'sağlık', 'çeşitli', 'bundan', 'hissetmek', 'oysa', 'sabah', 'teknik', 'dışarı',
             'merkez', 'ortam', 'yerine', 'düzey', 'köy', 'yönetim', 'aşağı', 'cevap', 'yatmak', 'toprak', 'akşam',
             'araştırma', 'götürmek', 'katılmak', 'yoksa', 'kurulmak', 'ödemek', 'sanki', 'kan', 'hasta', 'şehir',
             ...
             'gerekli', 'önem', 'koca', 'yanlış', 'varlık', 'art', 'sana', 'satış', 'doğal', 'sahipolmak',
             ...
             'yaşanmak', 'beyaz', 'öte', 'denmek', 'kardeş', 'çekilmek', 'nerede', 'çalmak', 'korku',
             'meslek', 'polis', 'yalnızca', 'açıklamak', 'fikir', 'hızlı', 'pencere', 'uğraşmak', 'taş', 'ateş', 'fark',
             'yetmek', 'çoğu', 'kimi', 'koşul', 'mahalle', 'mutlaka', 'tane', 'üretmek', 'üstüne', 'dayanmak',
             ...
             'sevgili', 'yaklaşmak', 'süreç', 'bakış', 'bilim', 'ifade', 'beden', 'hatırlamak', 'kaza',
             ...
             'getirilmek', 'metre', 'tutulmak', 'kalite', 'bitki', 'değişiklik', 'kredi', 'yasa', 'başarılı',
             ...
             'kırmızı', 'rol', 'şarkı', 'eleman', 'hazır', 'benzemek', 'birşey', 'hoca', 'boy', 'günlük', 'politika',
             ...
             'toplantı', 'gazeteci', 'nitelik', 'üzeri', 'bitirmek', 'gerçekleşmek', 'giriş', 'rahat',
             ...
             'belirlenmek', 'değerlendirmek', 'sürücü', 'süt', 'yakalamak', 'eşya', 'uluslararası', 'aday',
             'ağırlık', 'milyar', 'sağlılklı', 'sıkıntı', 'tanrı', 'tavır', 'toplumsal', 'yayın', 'dikkatetmek', 'sonderece',
             'toplanmak', 'yatırım', 'hafif', 'karışmak', 'tehlike', 'vakit', 'daire', 'fırsat', 'karıştırmak',
             'katkı', 'öykü', 'tamamen', 'uçak', 'yanıt', 'doğa', 'evlenmek', 'burun', 'çıkar', 'elbette',
             'kısaca', 'mağaza', 'medya', 'yüzünden', 'artış', 'çıkarılmak', 'kamu', 'sigorta', 'yaz', 'yürek', 'belge',
             'çaba', 'hergün', 'risk', 'sözetmek', 'sözcük', 'demokrasi', 'tuz', 'cami', 'çağ', 'düşük',
             'etraf', 'hızla', 'olanak', 'organ', 'öldürmek', 'öteki', 'sene', 'bozulmak', 'meyve', 'takılmak',
             'tatlı', 'bacak', 'değişim', 'kanun', 'rüzgar', 'cumhuriyet', 'geliştirmek', 'tarz', 'yedi', 'azalmak',
             'bağlamak', 'ceptelefonu', 'müdür', 'otel', 'yayımlanmak', 'zevk', 'binmek', 'güvenlik', 'hukuk',
             ...
             'gönül', 'hayal', 'şarap', 'yukarıda', 'altın', 'düzenlemek', 'satınalmak', 'sunulmak', 'temiz',
             'vitamin', 'ek', 'geç', 'hareketetmek', 'yumurta', 'aşırı', 'eylem', 'kesim', 'kriz', 'birim',
             'kapanmak', 'kahrolmak', 'boş', 'göz', 'kulak', 'burun', 'ayı', 'dal', 'merkez', 'maydanoz', 'mayonez', 'ketçap',
             'görüşmek', 'ülke', 'türkiye', 'olmak', 'üzere', 'toplam', 'bin', 'kez', 'özlemek', 'özenti', 'görüş',
             'kamera', 'arka', 'fon', 'müzik', 'fenomen', 'dizi', 'kurt', 'komik', 'komedi', 'ayrılık', 'fenalaşmak',
             ...
             'mühendis', 'mimar', 'malzeme', 'kalite', 'orman', 'dikmek', 'pratik', 'kolay', 'zekâ', 'çabuk', 'hızlı', 'çözüm',
             'mesai', 'saat', 'fazla', 'akşam', 'kalmak', 'akrostiş', 'şiir', 'mısra', 'kıta', 'bambu', 'sazlık',
             'mobilya', 'ağaç', 'masa', 'sandalye', 'yabani', 'vahşi', 'hayat', 'orman', 'hayvan', 'yelpaze', 'sıcak', 'rüzgar',
             'yaz', 'kadın', 'sallamak', 'çuval', 'torba', 'doldurmak', 'yem', 'un', 'koymak', 'ajanda', 'defter', 'yazmak', 'gün',
             'toplantı', 'acıkmak', 'kesilmek', 'açmak', 'lezzet', 'yemek', 'belediye', 'girmek', 'açmak', 'yolsuzluk',
             ...
             'kaçıyor', 'atlatmak', 'uykular', 'rüya','babacan', 'babacık', 'babadağ', 'babaevi', 'köşe', 'babalık', 'babasız', 'bacaklı', 'bacanak',
             'bacasız', 'bacı', 'bademci', 'bademli', 'bademsi', 'badem', 'bagetli', 'bağımlı', 'bağıntı', 'bağırma', 'bağışçı', 'bağışık', 'bağlama', 'bahadır',
             'baharat', 'baharcı', 'baharlı', 'bahçeci', 'bahçeli', 'bahisçi', 'zabıta', 'zafran', 'zağara', 'zağsız', 'zahire', 'zahir', 'zahmet', 'zahter',
